...
class MetadataGenerator:
    ...
    def __init__(
        self, settings_: Dict, fclnames: Dict, exe=POMS_EXE, defer_check=False
    ):
        ...
        try:
            ...
            print(
                f'Warning: No metadata executable specified in settings. Using "{exe}"'
            )
            pass
        ...
        if len(fclnames) == 0:
            raise ValueError(
                "Need to provide at least one stagename and corresponding fcl filename"
            )

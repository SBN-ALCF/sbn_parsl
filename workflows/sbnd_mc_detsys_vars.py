...
class Reco2FromGenExecutor(LArSoftExecutor):
    ...
    def __init__(self, cfg: Config):
        ...
        self.var_stage_order = [
            DefaultStageTypes.SCRUB,
            DefaultStageTypes.DETSIM,
            DefaultStageTypes.RECO1,
            DefaultStageTypes.RECO2,
            DefaultStageTypes.CAF,
        ...
        self.runfuncs = {
            key: functools.partial(
                mc_runfunc_sbnd, meta=self.meta[key], label=key, **common_args
            )
    ...
    def setup_single_workflow(self, iteration: int, input_files=None, last_file=None):
        ...
        for i in range(self.subruns_per_caf):
            ...
            for var, svar in var_caf_stages.items():
                ...
                svar_scrub = Stage(
                    DefaultStageTypes.SCRUB, stage_order=self.var_stage_order
                )
                ...
                svar_detsim.add_parents(svar_scrub)
